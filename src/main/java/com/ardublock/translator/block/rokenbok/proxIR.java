...
public class proxIR extends TranslatorBlock
{

	public proxIR(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
